...
function UserHome() {
  ...
  useEffect(() => {
    console.log(token);
  if(token){
       userAxios.get(`/getDetails?data=${1}`
    ).then((res)=>{
...
<Carousel />
<div  class='w-full h-fit   grid grid-cols-12   md:flex md:items-center sm:place-items-center sm:justify-evenly   gap-y-1 md:gap-6 bg-zinc-900  pl-5 pr-5 py-5'>
  {/* <Bann/>
  <Bann/>
  <Bann/>
  <Bann/> */}
      <div className='sm-h-[9rem] lg:mx-4 lg:my-1 h-[8rem] mt-4 md:mt-0 col-span-12 sm:col-span-6  md:h-[16rem] sm:w-[18rem] md:w-[28rem] lg:h-[19rem] border-b-[5px] border-sky-700 xl:h-[19rem] bg-black rounded-b text-white '>
     <Link to={'/proffesional/signup'}>register as mechanic</Link>
      </div>
      <div className='sm-h-[9rem] lg:mx-4 lg:my-1 h-[8rem] mt-4 md:mt-0 col-span-12 sm:col-span-6  md:h-[16rem] sm:w-[18rem] md:w-[28rem] lg:h-[19rem] border-b-[5px] border-sky-700 xl:h-[19rem] bg-black rounded-b text-white '>

      </div>
      <div className='sm-h-[9rem] lg:mx-4 lg:my-1 h-[8rem] mt-4 md:mt-0 col-span-12 sm:col-span-6  md:h-[16rem] sm:w-[18rem] md:w-[28rem] lg:h-[19rem] border-b-[5px] border-sky-700 xl:h-[19rem] bg-black rounded-b text-white '>
      <Link to={'/proffesional/signup'}>register as Freelancer</Link>
      </div>
      <div className='sm-h-[9rem] lg:mx-4 lg:my-1 h-[8rem] mt-4 md:mt-0 col-span-12 sm:col-span-6  md:h-[16rem] sm:w-[18rem] md:w-[28rem] lg:h-[19rem] border-b-[5px] border-sky-700 xl:h-[19rem] bg-black rounded-b text-white '>
